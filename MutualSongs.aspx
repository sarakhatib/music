<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="MutualSongs.aspx.cs" Inherits="MutualSongs" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <asp:Label ID="LabelError" runat="server" Text=""></asp:Label><br />
    <asp:Label ID="LabelUserNames" Font-Italic="true" ForeColor="#ff0066" runat="server"
        Text=""></asp:Label><br />
    <asp:GridView ID="GridViewMutualSongs" runat="server" AutoGenerateColumns="False"
